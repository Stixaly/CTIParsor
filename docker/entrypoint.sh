...
# environment or a .pgpass file -- so this is the one place that gap needs
# closing. A deployment that still sets PGPASSWORD directly via .env keeps
# working unchanged: this only overrides it when the secret file is present.
